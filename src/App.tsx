...
export default function App() {
  ...
  const handleHashChange = () => {
    ...
    setIsWidgetOnly(window.location.hash === '#widget');
  };
  ...
  // Widget Only View for Iframe Embedding
  if (isWidgetOnly) {
    return (
      <div className="h-screen w-screen flex items-end justify-end p-0 bg-transparent">
        <ChatWidget defaultOpen={true} hideLauncher={true} />
      </div>
    );
  }
